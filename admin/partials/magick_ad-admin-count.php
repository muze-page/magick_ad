...
class Magick_ad_Admin_Count
{
    ...
    public static function show_image_views()
    {
        ...
        //---------------------------------获取数据
        wp_enqueue_style('example-small-css', plugin_dir_url(__DIR__) . 'css/test.css', array(), '1.1126', true);
        wp_enqueue_script('my-image-views-test',  plugin_dir_url(__DIR__) . 'js/test.js', array(), '1.1126', true);
        wp_enqueue_script('my-image-views-script',  plugin_dir_url(__DIR__) . 'js/my-image-views.js', array(), '1.516', true);
